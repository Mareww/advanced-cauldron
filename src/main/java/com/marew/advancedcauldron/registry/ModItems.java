...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(AdvancedCauldron.MOD_ID, name), item);
    }

    public static void register() {
        AdvancedCauldron.LOGGER.info("Registering items for " + AdvancedCauldron.MOD_ID);

        // Add to ingredients tab (potions and brewing items are here in 1.20.1)
